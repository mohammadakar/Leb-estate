    ...
    <div>
        ...
        <div className="flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto">
            ...
            <div className="text-gray-500 text-xs sm:text-sm">
                Leb Estate is your best place to save your money by buying properties
                <br />
                We also have properties for renting 
                <br />
                Welcome for the wide range of properties you can choose from.
            </div>
